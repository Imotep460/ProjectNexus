...
//public class ObjectPoolController : MonoBehaviour, IPunPrefabPool
//{
...
//    public GameObject Instantiate(string bulletPrefabId, Vector3 bulletPrefabPosition, Quaternion bulletPrefabRotation)
//    {
//        GameObject bulletObject = Instantiate(objectPrefab);
//        bulletObject.transform.position = bulletPrefabPosition;
//        bulletObject.transform.rotation = bulletPrefabRotation;
